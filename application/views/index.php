...
<head>
    ...
    <title>Pustaka Informatika Bsi</title>
    ...
    <link href="<?= base_url('assets') ?>/css/style-flex.css" rel="stylesheet">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Sarana Ilmu Pustaka</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Membaca hal baru temukan inspirasi nya </h2>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                                    <div class="box">
                                        <img src="<?= base_url('assets') ?>/img/values-1.png" class="img-fluid" alt="" width="1100" height="500">
                                        <h3>Judul Buku</h3>
                                        <p>Pengarang</p>
                                        <p>Penerbit
                                    </div>
                            ...
                            <div class="carousel-item">
                                <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
                                    <div class="box">
                                        <img src="<?= base_url('assets') ?>/img/values-2.png" class="img-fluid" alt="" width="1100" height="500">
                            ...
                            <div class="carousel-item">
                                <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600" width="1100" height="500">
                                    <div class="box">
